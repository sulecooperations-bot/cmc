...
export default function RoadsPage() {
  ...
  let filteredAssets = mockData.assets.filter((a) => a.type === "road")
  if (selectedWard) {
    filteredAssets = filteredAssets.filter((a) => a.ward === selectedWard)
  }

  const handleRowClick = (asset: Asset) => {
    router.push(`/assets/road/${asset.id}`)
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Roads</h1>
          <p className="text-muted-foreground">Road infrastructure assets</p>
        </div>
        <Button>Add Road</Button>
      </div>
